...
env_parallel -j 2 --sshloginfile $PBS_NODEFILE --joblog jobs.log --retry-failed "Rscript --vanilla $SLURM_SUBMIT_DIR/linearcomponent_test.R" :::: lambdas.txt
