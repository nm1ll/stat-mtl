...
env_parallel -j 2 --sshloginfile $PBS_NODEFILE --joblog jobs.log --retry-failed "Rscript --vanilla $SLURM_SUBMIT_DIR/adjustment_svr_tuning_svronly.R" :::: lambdas.txt :::: loop.txt :::: costs.txt :::: gammas.txt
